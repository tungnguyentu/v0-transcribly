...
export function TranscriptionDetailContent({ id }: { id: string }) {
  const { transcription, isLoading, isError } = useTranscription(id)
        ...
        <Card className="md:col-span-1">
          ...
          <CardFooter>
            <Button asChild className="w-full">
              <a href={getDownloadUrl()} download={`${transcription.file_name.split(".")[0]}.${transcription.format}`}>
