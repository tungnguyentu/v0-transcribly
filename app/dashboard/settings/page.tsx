              ...
              <TabsContent value="transcription" className="space-y-4">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">Higher accuracy levels may take longer to process</p>
                    </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Configure the format of your transcription output</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <Label>Default Output Format</Label>
                      <RadioGroup defaultValue="srt">
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="srt" id="srt" />
                          <Label htmlFor="srt">SRT (SubRip Text)</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="max-chars" type="number" defaultValue="42" />
                      <p className="text-xs text-muted-foreground">
                        Recommended: 32-42 characters for optimal readability
                      </p>
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="line-duration">Maximum Line Duration (seconds)</Label>
                      <Input id="line-duration" type="number" defaultValue="5" />
                      <p className="text-xs text-muted-foreground">Recommended: 5 seconds for standard viewing</p>
                    </div>
                  </CardContent>
                  <CardFooter>
